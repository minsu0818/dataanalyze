...
숙박업이 많이 발달한 도시인 만큼 호텔도 많기 때문에 리뷰 또한 많다. 리뷰의 수가 많아지면 데이터의 표본수가 많이지는 것이므로 더 정확한 모델을 설계할 수 있을 것 같았다. 그래서 나는 런던의 호텔 리뷰로 mobile bert를 이용한 긍부정을 예측을 해볼까 한다   <br/><br/>
