...
숙박업이 많이 발달한 도시인 만큼 호텔도 많기 때문에 리뷰 또한 많다. 리뷰가 많다면 긍정적인 리뷰와 부정적인 리뷰가 둘다 많다는 건데 이러한 요소들이 호텔의 평점에 영향을 얼마나 끼치는지 알아 보기 위해 mobile bert를 이용한 런던 호텔 리뷰의 긍부정을 해볼까 한다   <br/><br/>
